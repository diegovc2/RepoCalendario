...
# simple class for activating, deactivating and uninstalling plugin
{
	...
	# this is only run when hooked by activating plugin
    {
		...
		__( "Your total payment is due by {paymentDate}.", 'book-a-room' ) . $lb . $lb . $lb . 
		'<strong>' . __( 'Request', 'book-a-room' ) . ":</strong> {eventName}" . $lb . 
		'<strong>' . __( 'Purpose', 'book-a-room' ) . ":</strong> {desc}" . $lb . $lb . 
		...
		'<strong>' . __( 'Event Name', 'book-a-room' ) . ":</strong> {eventName}" . $lb . 
		'<strong>' . __( 'Description', 'book-a-room' ) . ":</strong>{desc}" . $lb . $lb . 
		'<strong>' . __( 'Branch Name', 'book-a-room' ) . ":</strong> {branchName}" . $lb . 
		'<strong>' . __( 'Room Name', 'book-a-room' ) . ":</strong> {roomName}" . $lb . 
		'<strong>' . __( 'Date', 'book-a-room' ) . ":</strong> {date}" . $lb . 
		'<strong>' . __( 'Time', 'book-a-room' ) . ":</strong> {startTime} to {endTime}" . $lb . 
		...
		'<strong>' . __( 'Street Address 1', 'book-a-room' ) . ": </strong> {contactAddress1}" . $lb . 
		'<strong>' . __( 'Street Address 2', 'book-a-room' ) . ": </strong> {contactAddress2}" . $lb . 
		'<strong>' . __( 'Amenities', 'book-a-room' ) . ": </strong> {amenity}" . $lb . 
		'<strong>' . __( 'Branch Name', 'book-a-room' ) . ": </strong> {branchName}" . $lb . 
		'<strong>' . __( 'City', 'book-a-room' ) . ": </strong> {contactCity}" . $lb . 
		'<strong>' . __( 'Contact Name', 'book-a-room' ) . ": </strong> {contactName}" . $lb . 
		'<strong>' . __( 'Date', 'book-a-room' ) . ": </strong> {date}" . $lb . 
		'<strong>' . __( 'Email', 'book-a-room' ) . ": </strong> {contactEmail}" . $lb . 
		'<strong>' . __( 'End Time', 'book-a-room' ) . ": </strong> {endTime}" . $lb . 
		'<strong>' . __( 'Event Name', 'book-a-room' ) . ": </strong> {eventName}" . $lb . 
		'<strong>' . __( 'Nonprofit', 'book-a-room' ) . ":</strong> {nonProfit}" . $lb . 
		'<strong>' . __( 'Number of attendees', 'book-a-room' ) . ":</strong> {numAttend}" . $lb . 
		'<strong>' . __( 'Primary Phone', 'book-a-room' ) . ":</strong> {contactPhonePrimary}" . $lb . 
		'<strong>' . __( 'Purpose', 'book-a-room' ) . ":</strong> {desc}" . $lb . 
		'<strong>' . __( 'Room Name', 'book-a-room' ) . ":</strong> {roomName}" . $lb . 
		'<strong>' . __( 'Secondary Phone', 'book-a-room' ) . ":</strong> {contactPhoneSecondary}" . $lb . 
		'<strong>' . __( 'Start Time', 'book-a-room' ) . ":</strong> {startTime}" . $lb . 
		'<strong>' . __( 'State', 'book-a-room' ) . ":</strong> {contactState}" . $lb . 
		'<strong>' . __( 'Zip', 'book-a-room' ) . ":</strong> {contactZip}" . $lb;
		...
		'<strong>' . __( 'Start Time', 'book-a-room' ) . ":</strong> {startTime}" . $lb . 
		'<strong>' . __( 'State', 'book-a-room' ) . ":</strong> {contactState}" . $lb . 
		'<strong>' . __( 'Zip', 'book-a-room' ) . ":</strong> {contactZip}" . $lb . $lb . 
		'<strong>' . __( 'Room Deposit', 'book-a-room' ) . ":</strong> \${roomDeposit}" . $lb . 
		'<strong>' . __( 'Room Cost', 'book-a-room' ) . ":</strong> \${roomPrice}" . $lb . 
		'<strong>' . __( 'Total Cost', 'book-a-room' ) . ":</strong> \${totalPrice}" . $lb . 
		__( "Your total payment is due by {paymentDate}.", 'book-a-room' ) . $lb;
