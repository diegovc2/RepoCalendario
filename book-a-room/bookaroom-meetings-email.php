...
class bookaroom_settings_email {
	...
	function testEmail( $bookaroom_alertEmail ) {
		...
		//A PARTIR DE AQUI PARTE LA COSA
/*
...
try {
    ...
    $mail->Username = 'cincelaquiles@gmail.com';                 // SMTP username
    $mail->Password = 'android92';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('from@example.com', 'Mailer');
    $mail->addAddress('diegoveloso34@hotmail.com','Diego Veloso');     // Add a recipient
